    ...
    function registeration()
      {
        ...
        {   
              ...
              {
                $sql="INSERT INTO users (usernm,fulnm,pasword,phonnu,email,companam,adrs,usr_typ) VALUES ('$username','$fullname','$password','$phone','$email','$cmpny','$adrs','$user_typ')";
          ...
          function registeration()
          {
            ...
            if(isset($compelet) && $compelet > 5 )
              {  
                ...
                $user_id  = $formtyp;
                 $sql= "UPDATE `users` SET `usernm`='$username',`fulnm`='$fullname',`pasword`='$password' ,`phonnu`='$phone',`email`='$email',`companam`='$cmpny',`adrs`='$adrs',`usr_typ`='$usrtyb' WHERE id= $user_id";
                $result= @mysqli_query($db,$sql);           
                 echo "done";
              }
          } 
